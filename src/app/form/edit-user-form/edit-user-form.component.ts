...
@Component({
  ...
  styleUrls: ['./edit-user-form.component.less']
})
export class EditUserFormComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.formService.readUserForm(this.line.userUID, this.consentId).subscribe((item) => {
      try {

        // Keep value in variable s
        ...
        item['attributes'].map((att) => {
          ...
          this.formService.editSubUserFormVersion(
            this.line.userUID,
            this.consentId,
            this.title,
            this.formAttributes,
